...
BC = HERE / "external" / "barchart"
SRC = BC / "processed" / "historical_panel_2002_summary.csv"
PANEL0 = BC / "processed" / "historical_panel_2002_gap_safe.csv"
RESULT = BC / "processed" / "historical_var_2002_FINAL_gap_safe.csv"
LOMO = BC / "processed" / "historical_var_2002_FINAL_lomo.csv"
...
def estimate(keep):
    ...
    bi, sei, ti, pi = block_hac(X, yi, groups, 6)
    bf, sef, tf, pf = block_hac(X, yf, groups, 6)
...
# Freeze expected numerical reproduction with a small floating tolerance.
